...
style.configure(
    "label1.TLabel", background="#E4E2E2", foreground="#000", anchor="center"
)
...
# Box Size
style.configure(
    "label2.TLabel", background="#E4E2E2", foreground="#000", anchor="center"
)
label2 = ttk.Label(
    master=main, text="Box Size (Pixels Per Box):", style="label2.TLabel"
)
...
qr = ImageLabel(
    ...
    image_path=os.path.join(
        BASE_DIR, "assets", "images", "Screenshot 2026-09-17 012553.png"
    ),
    text="",
    compound=tk.TOP,
    mode="cover",
...
style.configure(
    "label3.TLabel", background="#E4E2E2", foreground="#000", anchor="center"
)
...
# Title
style.configure(
    "label4.TLabel", background="#E4E2E2", foreground="#000", anchor="center"
)
